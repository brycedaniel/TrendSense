...
def transform_data(request):
    ...
    try:
        ...
        return json.dumps({"message": f"Successfully processed and loaded {new_rows} rows to BigQuery"}), 200  # ✅ Always returns

    except Exception as e:
        return json.dumps({"error": str(e)}), 500  # ✅ Return error as JSON string
